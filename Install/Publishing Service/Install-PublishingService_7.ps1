### Name: Install Publishing Service 7.0.0
### Description: Installs Sitecore Publishing Service
### Compatibility: Sifon 1.2.7
### $Urls = new Sifon.Shared.Forms.PackageVersionSelectorDialog.PackageVersionSelector::GetFile("$PSScriptRoot\Install-PublishingService_7.json")
...
if(-not (Verify-NetCoreHosting -MinimumVersion "6.0.0"))
{
        $ErrorMessage  = @(
            ...
            "",
            "",
            "Publishing Service 7 requires '.NET Core Hosting' bundle version 6.0.403 or higher"
            "",
