...
{
    "."
    Show-Message -Fore "White" -Back "Yellow" -Text "You've have selected the folder: $SelectedFolder"
    "."
}
else
{
...
"."
Show-Message -Fore ForestGreen -Back White -Text "Sitecore CLI successfully installed at: $SelectedFolder"
